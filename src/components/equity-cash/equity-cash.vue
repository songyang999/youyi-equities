...
<template>
    <view class="deliver_bac" catchtouchmove="true" @click.stop>
        <view class="deliver_wrap">
            ...
            <view class="form-box">
                <uni-forms ref="ruleForm" :model-value="formData" :rules="rules" validate-trigger="blur" label-width="105">
                    <view class="select-box mb-30">
                        <uni-forms-item name="equity" :rules="rules['equity']['rules']">
                            ...
                            <view class="input-box flex justify-between align-center" @click="openOnePicker">
                                <view v-if="formData.equity" class="fs-26 main_text">{{ formData.equity_format }}</view>
                    ...
                    <button type="primary" hover-class="none" @click="handleSubmit">确认兑换</button>
                </uni-forms>
            </view>
        </view>
    </view>
